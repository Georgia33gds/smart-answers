...
private
  ...
  def find_smart_answer
    ...
    current_state = SmartAnswer::ResolveState.new(@smart_answer).from_params(request.params)
    @presenter = FlowPresenter.new(@smart_answer, current_state)
  end
