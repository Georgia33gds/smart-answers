...
module SmartAnswer
  class CheckboxQuestionPresenterTest < ActiveSupport::TestCase
    ...
    test "#checkboxes can mark checkboxes as checked from an array current response" do
    ...
    test "#checkboxes can mark checkboxes as checked from a string current response" do
